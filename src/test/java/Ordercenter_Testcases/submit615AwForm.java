...
public class submit615AwForm extends Baseclass {
	...
	public test615Aw asi;

	@Test(dataProvider = "test1", retryAnalyzer = RetryAnalysisPackage.RetryOne.class)

	public void ValidateDoorNumberSubmition(String date, String modelva, String doorQuty, String spfValue,
	...
	public String[][] data() throws EncryptedDocumentException, IOException {
		...
		String path = "C:\\Users\\webca\\eclipse-workspace\\ordercenterASI\\testdata_615Aw\\FinalSubmission.xlsx";
