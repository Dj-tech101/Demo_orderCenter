...
public class test615Aw {
	...
	public test615Aw(WebDriver driver) {
	...
	@FindBy(xpath = "//table/tbody/tr[38]/td[2]")
...
//			WebElement element = wait.until(ExpectedConditions.visibilityOf(ModelErrorMessage));		;
	...
	@FindBy(xpath = "(//div[@aria-haspopup='listbox'])[30]")
...
//			WebElement element = wait.until(ExpectedConditions.visibilityOf(ModelErrorMessage));		;
	...
	@FindBy(xpath = "(//div[@aria-haspopup='listbox'])[31]")
...
//			WebElement element = wait.until(ExpectedConditions.visibilityOf(ModelErrorMessage));		;
	...
	public void callFinalSubmission(String date, String modelva, String doorQuty, String spfValue, String doorWid,
			String doorHeig, String doorloc, String motorLoc, String windowqty, String incomingpower,
